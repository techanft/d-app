...
export const TOKEN_SYMBOL = 'CNFT';
export const _window = window as unknown as IWindowEth;

export const USING_TESTNET = true; // Network toggler 

export const SERVICE_API_URL = USING_TESTNET ?  'https://app.checkland.co/api/' : 'https://app.checkland.co/api/' ;
export const MANAGEMENT_SITE_URL = USING_TESTNET ? 'https://checkland.co/' : 'https://checkland.co/';
